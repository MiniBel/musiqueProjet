					...
					<tbody>
						<c:forEach items="${artistes }" var="artiste">
							<tr>
								...
								<td>
									<a href="royalty-modifier-artiste?id=${artiste.id }"class="btn btn-warning">Modifier </a>
									<a href="royalty-supprimer-artiste?id=${artiste.id }"class="btn btn-danger">Supprimer</a>
