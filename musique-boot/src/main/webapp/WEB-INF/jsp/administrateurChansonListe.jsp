...
<title>Royalty.Accueil.Administrateur</title>
<!-- CSS only -->
<link
					...
					<tbody>
						<c:forEach items="${ chansons }" var="chanson">
							<tr>
								...
								<td>${ chanson.duree }</td>
								<td>
									<a href="#?id=${ chanson.id }" class="btn btn-primary">Voir les
										albums</a>
								</td>
								<td>
									<a href="#?id=${ chanson.id }" class="btn btn-primary">Voir les
								...
								<td>
								<a href="royalty-modifier-chanson?id=${ chanson.id }" class="btn btn-warning">Modifier</a> 
								<a href="royalty-supprimer-chanson?id=${ chanson.id }" class="btn btn-danger">Supprimer</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
